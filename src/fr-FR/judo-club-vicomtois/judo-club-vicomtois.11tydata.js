    ...
    return {
        data: {
            ...
            about: {
                ...
                paragraphs: [
                    `Le ${charityName} propose des activités sportives à partir de 4 ans : éveil judo , judo, jujitsu, taïso, taïso seniors et self défense 100% féminin. Labellisé : "sport et handicaps" et labellisé "club femmes et sport".`,
