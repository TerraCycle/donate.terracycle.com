...
module.exports = () => {
    return {
        data: {
            ...
            header: {
                title: "Collecter des dons pour <strong>THAWA échange et partage</strong>",
            },
            introduction: {
                charityLogoFileName: "", // ⚠️ Missing logo!
                paragraphs: [
                    "Pendant les fêtes de fin d'année, faites un don à <strong>THAWA échange et partage</strong> en recyclant gratuitement avec TerraCycle ! En envoyant vos déchets à TerraCycle (frais d'envoi gratuits), vous agissez positivement pour l'environnement et aidez <strong>THAWA échange et partage</strong>. Envoyez vos déchets d'emballages à TerraCycle, qui fera don de 10 euros à <strong>THAWA échange et partage</strong> pour chaque colis reçu.",
            ...
            howItWorks: {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        text: "Et hop, vous venez de faire un don à <strong>THAWA échange et partage</strong> gratuitement!",
                ...
                closingSentence:
                    "N'oubliez pas d'expédier vos emballages <strong>au plus tard le 15 décembre</strong> pour que <strong>THAWA échange et partage</strong> reçoive le plus de dons possible de la part de TerraCycle. Les envois reçus après le 31 décembre ne pourront bénéficier que des activations standard offertes. ",
            },
            about: {
                title: "À propos de <strong>THAWA échange et partage</strong>",
                paragraphs: [
