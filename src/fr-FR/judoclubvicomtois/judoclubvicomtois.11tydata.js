...
const charityName = "Judo Club Vicomtois";
...
module.exports = () => {
    return {
        data: {
            ...
            header: {
                title: "Collecter des dons pour <strong>Judo Club Vicomtois</strong>",
            },
            introduction: {
                charityLogoFileName: "TC Charity Microsite - Charity Logo Resize, FR, Mobile_Judo Club Vicomtois.jpg",
                paragraphs: [
                    "Pendant les fêtes de fin d'année, faites un don à <strong>Judo Club Vicomtois</strong> en recyclant gratuitement avec TerraCycle ! En envoyant vos déchets à TerraCycle (frais d'envoi gratuits), vous agissez positivement pour l'environnement et aidez <strong>Judo Club Vicomtois</strong>. Envoyez vos déchets d'emballages à TerraCycle, qui fera don de 10 euros à <strong>Judo Club Vicomtois</strong> pour chaque colis reçu.",
            ...
            howItWorks: {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        text: "Et hop, vous venez de faire un don à <strong>Judo Club Vicomtois</strong> gratuitement!",
                ...
                closingSentence:
                    "N'oubliez pas d'expédier vos emballages <strong>au plus tard le 15 décembre</strong> pour que <strong>Judo Club Vicomtois</strong> reçoive le plus de dons possible de la part de TerraCycle. Les envois reçus après le 31 décembre ne pourront bénéficier que des activations standard offertes.",
            },
            about: {
                title: "À propos de <strong>Judo Club Vicomtois</strong>",
                paragraphs: [
                    'Le judo club vicomtois propose des activités sportives à partir de 4 ans : éveil judo , judo, jujitsu, taïso, taïso seniors et self défense 100% féminin. Labellisé : "sport et handicaps" et labellisé "club femmes et sport".',
                    "<a href='https://www.judoclubvicomtois.com/'>www.judoclubvicomtois.com</a>",
                    "Les dons TerraCycle permettent de contribuer à l'achat de matériel spécifique."
                ],
            },
