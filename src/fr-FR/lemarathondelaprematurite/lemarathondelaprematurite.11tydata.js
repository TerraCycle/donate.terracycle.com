...
const charityName = "Le Marathon de la Prématurité";
...
module.exports = () => {
    return {
        data: {
            ...
            header: {
                title: "Collecter des dons pour <strong>Le Marathon de la Prématurité</strong>",
            },
            introduction: {
                charityLogoFileName: "TC Charity Microsite - Charity Logo Resize, FR, Mobile_Le Marathon de la Prématurité.jpg",
                paragraphs: [
                    "Pendant les fêtes de fin d'année, faites un don au Marathon de la Prématurité en recyclant gratuitement avec TerraCycle ! En envoyant vos déchets à TerraCycle (frais d'envoi gratuits), vous agissez positivement pour l'environnement et aidez <strong>Le Marathon de la Prématurité</strong>. Envoyez vos déchets d'emballages à TerraCycle, qui fera don de 10 euros au Marathon de la Prématurité pour chaque colis reçu.",
            ...
            howItWorks: {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        text: "Et hop, vous venez de faire un don au Marathon de la Prématurité gratuitement!",
                ...
                closingSentence:
                    "N'oubliez pas d'expédier vos emballages <strong>au plus tard le 15 décembre</strong> pour que <strong>Le Marathon de la Prématurité</strong> reçoive le plus de dons possible de la part de TerraCycle. Les envois reçus après le 31 décembre ne pourront bénéficier que des activations standard offertes. ",
            },
            about: {
                title: "À propos du Marathon de la Prématurité",
                paragraphs: [
                    "L’association a pour mission de soutenir les parents vivant une ou plusieurs naissances prématurées, ou côtoyant un service de néonatalogie pour une autre raison. Si nécessaire, elle aide financièrement les familles venant de loin afin de maintenir le lien de proximité en leur permettant une présence au quotidien (nuitées, trajets). Le financement du matériel spécifique pour les services de néonatalogie tels que des coussins d’allaitement, l’aménagement de la salle d’allaitement permettent un meilleur confort des bébés et des parents"    
                ],
            },
