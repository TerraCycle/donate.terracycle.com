...
const charityName = "Operation: Care &amp; Comfort";
...
module.exports = () => {
    return {
        data: {
            ...
            introduction: {
                charityLogoFileName: "TC Charity Microsite - Charity Logo Resize, US, Mobile_Operation Care and Comfort.jpg",
                paragraphs: [
            ...
            about: {
                ...
                paragraphs: [
                    `Founded in San Jose CA in 2003, our mission is to provide comfort to troops deployed overseas, and veterans, and their families here at home.`,
                    `Our all-volunteer organization has distributed over 2 million pounds of care packages. Here at home, we assist and honor military/veteran families through our Tickets for Troops and Adopt a Military Family programs. We serve veterans regardless of when they served, or the length of their service.`,
                    `<a href="https://www.occ-usa.org/" target="_blank" rel="noopener">https://www.occ-usa.org/</a>`,
                ],
            },
