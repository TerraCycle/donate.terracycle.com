...
const charityName = "Delaware Valley Friends School";
...
module.exports = () => {
    return {
        data: {
            ...
            introduction: {
                charityLogoFileName: "TC Charity Microsite - Charity Logo Resize, US, Mobile_DV Friends.jpg",
                paragraphs: [
            ...
            about: {
                ...
                paragraphs: [
                    `One of the nation’s best schools for bright students who learn differently, ${charityName} delivers an extraordinary education in grades 1–12 within a nurturing, inclusive Quaker learning community. Our Quaker beliefs help all students feel supported and encouraged, thrive in an environment that celebrates differences and each person’s inherent worth, work towards creating an inclusive community, and learn to recognize their own strengths while discovering new passions. Our innovative curriculum, designed and led by expert educators, ensures students gain the skills and confidence to chart ambitious academic journeys.`,
                    `Stewardship is one of the Quaker values that guides our school. This is expressed throughout our curriculum and choices we make in our facilities and operations, and also finds expression in some student-led efforts, including an environmental club and gardening club. Funds raised through ${site.brandName} programs help support these important initiatives.`,
                    `<a href="https://www.dvfriends.org/" target="_blank" rel="noopener">www.dvfriends.org</a>`,
                ],
            },
