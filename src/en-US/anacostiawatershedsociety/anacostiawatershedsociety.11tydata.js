...
const charityName = "Anacostia Watershed Society";
...
module.exports = () => {
    return {
        data: {
            ...
            introduction: {
                charityLogoFileName: "TC Charity Microsite - Charity Logo Resize, US, Mobile_Anacostia Watershed Society.jpg",
                paragraphs: [
            ...
            about: {
                ...
                paragraphs: [
                    `The Anacostia River touches countless communities across the DC region before flowing into the Chesapeake Bay. Though it has suffered from generations of neglect, the promise of a healthy and clean river is within reach. Dedicated to the restoration of the watershed, the ${charityName} mobilizes the community to clean, protect, and reconnect with the river. Through hands-on service learning, it engages thousands of local students each year in restoring wetlands and cleaning up the shores; and it advocates on the river’s behalf, seeking better stormwater controls and smarter green development.`,
                    `<a href="https://www.anacostiaws.org/" target="_blank" rel="noopener">https://www.anacostiaws.org/</a>`,
                ],
            },
