...
module.exports = () => {
    return {
        data: {
            ...
            introduction: {
                charityLogoFileName: "TC Charity Microsite - Charity Logo Resize, US, Mobile_Scarce I Environmental Education.jpg",
                paragraphs: [
            ...
            about: {
                ...
                paragraphs: [
                    `Established in 1990, ${charityName} is an environmental education not-for-profit organization.`,
                    `Our mission is to inspire people, through education, to preserve and care for the Earth's natural resources.`,
                    `We provide innovative, hands-on educational programs to members in the community and we operate a facility where we reuse and recycle household items to keep them from the landfill.`,
                    `${charityName} helps people discover how easy it can be to make a meaningful difference for our kids, for our environment, for our future…and often for all three at once.`,
                    `<a href="https://www.scarce.org/" target="_blank" rel="noopener">scarce.org</a>`,
                ],
            },
