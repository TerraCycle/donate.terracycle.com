...
const charityName = "Willis Lane Elementary PTA";
    ...
    return {
        data: {
            ...
            about: {
                ...
                paragraphs: [
                    `${charityName} is a group of parents, teachers &amp; administrators with a common goal, "Making Every Child's Potential a Reality." Our Mission is... to allow a powerful voice for all children, to provide relevant resources for families, and to be a strong advocate for the education and well being of every student.`,
                    `Help us support this community through these "super recycling" resources.`,
                    `We thank you for your participation!`,
                    `<a href="https://wlespta.net/" target="_blank" rel="noopener">https://wlespta.net/</a>`,
                ],
            },
