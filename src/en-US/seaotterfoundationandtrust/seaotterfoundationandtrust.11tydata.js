...
const charityName = "Sea Otter Foundation &amp; Trust";
...
module.exports = () => {
    return {
        data: {
            ...
            introduction: {
                charityLogoFileName: "TC Charity Microsite - Charity Logo Resize, US, Mobile_Sea Otter Foundation and Trust.jpg",
                paragraphs: [
            ...
            about: {
                ...
                paragraphs: [
                    `The mission of the ${charityName} is ensuring the survival and recovery of sea otters (Enhydra lutris) in their habitats by building funds to support research, conservation and education. We are proud to be the only nonprofit organization giving grant dollars directly to sea otter biologists and conservation initiatives dedicated to this endangered species.`,
                    `We are volunteer-based, so donations received go directly into our granting fund or to support our educational programs for the sea otter.`,
                    `<a href="https://seaotterfoundationtrust.org/" target="_blank" rel="noopener">www.SeaOtterFoundationTrust.org</a>`,
                ],
            },
