...
const charityName = "Peace Advocacy Network";
...
module.exports = () => {
    return {
        data: {
            ...
            introduction: {
                charityLogoFileName: "TC Charity Microsite - Charity Logo Resize, US, Mobile_PAN Peace Advocacy Network.jpg",
                paragraphs: [
            ...
            about: {
                ...
                paragraphs: [
                    `${charityName} (PAN) promotes a peaceful existence through veganism, social justice, and respect for the Earth’s inhabitants and resources.`,
                    `PAN, founded in 2010, is a grassroots group that strives for the absence of violence in the lives of people and animals by eliminating oppression and inequity.`,
                    `<a href="https://peaceadvocacynetwork.org/" target="_blank" rel="noopener">https://peaceadvocacynetwork.org/</a>`,
                ],
            },
