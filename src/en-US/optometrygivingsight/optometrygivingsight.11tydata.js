...
const charityName = "Optometry Giving Sight";
...
module.exports = () => {
    return {
        data: {
            ...
            introduction: {
                charityLogoFileName: "TC Charity Microsite - Charity Logo Resize, US, Mobile_Optometry Giving Sight.jpg",
                paragraphs: [
            ...
            about: {
                ...
                paragraphs: [
                    `Communities around the world suffer from unnecessary blindness or vision impairment simply because they don’t have access to eye exams and appropriate glasses. With the support of the optometric industry, patients and donors, ${charityName} funds programs to deliver desperately needed vision care, train local eye care professionals and develop sustainable infrastructure in developing countries. Our vision is a world with universal access to eye health services and solutions for those in need. Sight can make the difference between a life of poverty and one of opportunity.`,
                    `Our website is: <a href="https://givingsight.org/" target="_blank" rel="noopener">www.givingsight.org</a>.`,
                ],
            },
