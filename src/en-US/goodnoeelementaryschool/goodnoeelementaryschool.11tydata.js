...
const charityName = "Goodnoe Elementary School";
...
module.exports = () => {
    return {
        data: {
            ...
            introduction: {
                charityLogoFileName: "TC Charity Microsite - Charity Logo Resize, US, Mobile_Goodnoe Elementary School.jpg",
                paragraphs: [
            ...
            about: {
                ...
                paragraphs: [
                    `The mission of the PTO is to provide support for the students and staff of ${charityName} by fostering the continued cooperation and communication between home and school and parents and teachers for the growth, education, and overall welfare of the children of ${charityName} and the community. The PTO also develops programs and projects which support the goals of ${charityName} and help develop a relationship between the educators and the general public to promote physical, mental, and social growth for all children.`,
                    `<a href="https://www.gespto.org/" target="_blank" rel="noopener">www.gespto.org</a>`,
                ],
            },
