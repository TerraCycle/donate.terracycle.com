...
const charityName = "Keep America Beautiful";
...
module.exports = () => {
    return {
        data: {
            ...
            introduction: {
                charityLogoFileName: "TC Charity Microsite - Charity Logo Resize, US, Mobile_Keep America Beautiful.jpg",
                paragraphs: [
