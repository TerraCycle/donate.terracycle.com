...
module.exports = () => {
    return {
        data: {
            ...
            introduction: {
                charityLogoFileName: "TC Charity Microsite - Charity Logo Resize, US, Mobile_Sisters for Souls.jpg",
                paragraphs: [
            ...
            about: {
                ...
                paragraphs: [
                    `${charityName} is a nonprofit organization serving our local communities.`,
                    `Our mission is: "Providing Communities with Life's Essentials".`,
                    `Life's essentials are not always easy to come by for everyone.`,
                    `We provide meals, personal care items, masks, book bags with school supplies, blankets, winter coats and more.`,
                    `We have sponsored some shelters by serving hot, on the spot meals.`,
                    `<a href="https://sistersforsouls.org/" target="_blank" rel="noopener">sistersforsouls.org</a>`,
                ],
            },
