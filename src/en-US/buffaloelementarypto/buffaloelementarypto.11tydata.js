...
const charityName = "Buffalo Elementary PTO";
    ...
    return {
        data: {
            ...
            about: {
                ...
                paragraphs: [
                    `${charityName} is organized exclusively for charitable and educational purposes:`,
                    `A. To promote the welfare of children and youth in home, school, and community;<br /> B. To promote the communication between parents, school, and students through an exchange of ideas on topics of mutual interest;<br /> C. To raise the standards of home life;<br /> D. To secure adequate laws for the care and protection of children and youth;<br /> E. To bring into clearer relation the home and school so that parents and teachers may cooperate intelligently in the training of the child;<br /> F. To sponsor and promote fundraising projects for school; and<br /> G. To develop between educators and the community such united efforts as will secure for every child the highest advantages in physical, mental, and social education.`,
                    `<a href="https://buffalopto.membershiptoolkit.com/" target="_blank" rel="noopener">https://buffalopto.membershiptoolkit.com/</a>`,
                ],
            },
