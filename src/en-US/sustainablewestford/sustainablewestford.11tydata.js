...
const charityName = "Sustainable Westford";
...
module.exports = () => {
    return {
        data: {
            ...
            introduction: {
                charityLogoFileName: "TC Charity Microsite - Charity Logo Resize, US, Mobile_Sustainable Westford.jpg",
                paragraphs: [
            ...
            about: {
                ...
                paragraphs: [
                    `${charityName} serves as a venue for bringing community together and raising awareness on issues of sustainability. We do this by providing education and inspiration on issues of sustainability.`,
                    `Working with the community and related organizations to advance our mutual missions, we provide access to recycling programs; renewable energy options; conservation of natural resources; and health and wellness programs.`,
                    `Most recently we have partnered with Westford Climate Action to advance Westford as a leader in sustainability.`,
                    `<a href="https://sustainablewestford.org/" target="_blank" rel="noopener">https://sustainablewestford.org/</a>`,
                ],
            },
