...
const charityName = "Eisenhower Elementary School";
...
module.exports = () => {
    return {
        data: {
            ...
            introduction: {
                charityLogoFileName: "TC Charity Microsite - Charity Logo Resize, US, Mobile_Eisenhower Elementary School.jpg",
                paragraphs: [
            ...
            about: {
                ...
                paragraphs: [
                    `EcoEagles Green Team is open to all ${charityName} students in grades 1-5.`,
                    `Our team activities are designed to increase children's awareness of environmental topics and to promote positive green actions in our school and beyond. We engage with the broader community to support sustainability efforts whenever possible. The EcoEagles have a genuine impact on our school community and have won numerous awards and honors.`,
                    `<a href="https://eie.bvsd.org/" target="_blank" rel="noopener">https://eie.bvsd.org/</a>`,
                ],
            },
