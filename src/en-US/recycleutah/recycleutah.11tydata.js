...
const charityName = "Recycle Utah";
...
module.exports = () => {
    return {
        data: {
            ...
            introduction: {
                charityLogoFileName: "TC Charity Microsite - Charity Logo Resize, US, Mobile_Recycle Park City Utah.jpg",
                paragraphs: [
            ...
            about: {
                ...
                paragraphs: [
                    `The Park City Conservation Association dba ${charityName} is a nonprofit, 501(c)(3) organization that has served residents of Summit County since 1991. We are committed to reducing waste and preventing groundwater pollution in our community. We do so by offering a variety of collection programs, education programs, workshops, and events. Our mission is to empower people to lead sustainable lives.`,
                    `<a href="https://www.recycleutah.org/" target="_blank" rel="noopener">www.recycleutah.org</a>`,
                ],
            },
