...
const charityName = "Spencer-Van Etten Middle School Greenhouse Program";
...
module.exports = () => {
    return {
        data: {
            ...
            introduction: {
                charityLogoFileName: "TC Charity Microsite - Charity Logo Resize, US, Mobile_Spencer Van Eten Centeral School District.jpg",
                paragraphs: [
            ...
            about: {
                ...
                paragraphs: [
                    `The ${charityName} promotes education, health and wellness, environmental awareness, community relationships and a life long enjoyment for horticulture.`,
                    `In collaboration with the district and community, the Greenhouse Program promotes sustainability and healthy living through education, yearly recycling initiatives, and an annual Green Week among other festivities.`,
                    `<a href="https://www.svecsd.org/" target="_blank" rel="noopener">www.svecsd.org</a>`,
                ],
            },
