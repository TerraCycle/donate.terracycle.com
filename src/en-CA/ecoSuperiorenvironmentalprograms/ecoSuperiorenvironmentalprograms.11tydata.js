...
module.exports = () => {
    return {
        data: {
            ...
            introduction: {
                charityLogoFileName: "TC Charity Microsite - Charity Logo Resize, CA_EcoSuperior.jpg",
                charityLogoHeight: {
                    mobile: 60,
                    desktop: 110,
                },
            ...
            about: {
                ...
                paragraphs: [
                    ...
                    "Services including home energy assessments, teacher training and administration of municipal rebate programs are also provided. EcoSuperior's office, centrally located in Thunder Bay, is also a public resource centre and offers a small retail area where eco-friendly items such as rain barrels, composters, radon kits, reusable plastic alternatives and heritage seeds can be purchased. The organization is widely recognized as a leader in environmental outreach, engaging thousands of youth and adults in programming annually to fulfill the mission of building a healthy future for people and the planet.", 
                    `<a href='https://www.ecosuperior.org/' target='_blank' rel='noopener'>https://www.ecosuperior.org/</a>`,
                ],
            },
