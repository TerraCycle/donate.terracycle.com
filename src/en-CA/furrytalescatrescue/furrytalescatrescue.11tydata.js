...
const charityName = "Furry Tales Cat Rescue";
...
module.exports = () => {
    return {
        data: {
            ...
            introduction: {
                charityLogoFileName: "furry_tales_cat_rescue.jpg",
                charityLogoHeight: {
                    mobile: 70,
                    desktop: 120,
                },
            ...
            about: {
                ...
                paragraphs: [
                    "Furry Tales Cat Rescue is a foster-based agency located in Smiths Falls, Ontario.",
