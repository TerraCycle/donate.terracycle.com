    ...
    return {
        data: {
            ...
            header: {
                ...
                paragraphs: [`Send ${site.brandName}® your trash (free shipping) to be recycled; ${site.brandName} will donate $1 to ${charityName} by Brain Garden & The Kootenay Planeteers Recycling Society`],
            },
            introduction: {
