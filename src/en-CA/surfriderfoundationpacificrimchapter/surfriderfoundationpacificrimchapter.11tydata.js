...
const charityName = "Surfrider Foundation, Pacific Rim Chapter";
...
module.exports = () => {
    return {
        data: {
            ...
            introduction: {
                charityLogoFileName: "surfrider_foundation_pacific_rim_chapter.jpg",
                charityLogoHeight: {
                    mobile: 60,
                    desktop: 110,
                },
