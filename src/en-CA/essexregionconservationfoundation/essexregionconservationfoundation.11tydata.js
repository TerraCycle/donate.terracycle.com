...
const charityName = "Essex Region Conservation Foundation";
...
module.exports = () => {
    return {
        data: {
            ...
            introduction: {
                charityLogoFileName: "essex_region_conservation_foundation.jpg",
                charityLogoHeight: {
                    mobile: 55,
                    desktop: 100,
                },
