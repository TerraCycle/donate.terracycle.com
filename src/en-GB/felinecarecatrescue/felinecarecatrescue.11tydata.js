...
const charityName = "Feline Care Cat Rescue";
...
module.exports = () => {
    return {
        data: {
            ...
            introduction: {
                charityLogoFileName: "141047 Feline Care Cat Rescue-Mobile.jpg",
                paragraphs: [
            ...
            about: {
                ...
                paragraphs: [
                    `At Feline Care our priority is cats and we love all cats. We want to help those who need us most and offer sanctuary to those who are truly unwanted by the world around them. All cats deserve the same rights to safety, love and care and our four acre, cat-proofed grounds with purpose built cattery is here to help as many as we can.`,
                    `We look forward to finding the perfect home for all the cats in our care while acknowledging some will happily live out their days knowing Feline Care is their home. We look forward to the day there are more homes than there are cats but for now we're proud to be their security and sanctuary.`,
                ],
            },
