...
const charityName = "Birmingham Children's Hospital Charity";
...
module.exports = () => {
    return {
        data: {
            ...
            introduction: {
                charityLogoFileName: "BCH CharityDMFSKLogo-InAidOf - CMYK-01-Mobile.png",
                paragraphs: [
            ...
            about: {
                ...
                paragraphs: [
                    `At ${charityName}, we believe there’s always more we can do for our sick kids, and that’s why we strive to be exceptional in raising vital funds needed to make a real difference to children and their families, because every patient deserves a childhood.`,
                    `As well as improving the way we work, we know our supporters are often as concerned about the environment as we are, and want to ensure their fundraising doesn’t add to their environmental impact. So, why not recycle and raise funds for our charity?`,
                ],
            },
