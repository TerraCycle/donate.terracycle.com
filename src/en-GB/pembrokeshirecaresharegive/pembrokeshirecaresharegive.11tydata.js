...
const charityName = "Pembrokeshire Care, Share &amp; Give";
...
module.exports = () => {
    return {
        data: {
            ...
            introduction: {
                charityLogoFileName: "14197 Pembrokeshire Care, Share _ Give-Mobile.jpg",
                paragraphs: [
            ...
            about: {
                ...
                paragraphs: [
                    `${charityName} is a Non Profit Charity (charity no 1175646) set up in 2009 to promote sustainability through recycling items that would otherwise have gone to Landfill. All funds raised go to helping lots of charities and the local community.`,
                ],
            },
