...
const charityName = "Yeovil Freewheelers";
    ...
    return {
        data: {
            ...
            about: {
                ...
                paragraphs: [
                    `${charityName} is a group of emergency volunteer bikers operating out of Yeovil and Wincanton Hospitals. The demand for our services is still growing after 40 years supporting the NHS. We are the oldest surviving blood bike group in the country. Last year we made over 1000 out-of-hours deliveries, carrying blood, platelets, blood and tissue samples, medication, breast milk, medical documents, CT scans and medical equipment to hospitals, hospices, and nursing homes as well as private addresses, which are often in isolated areas, across most of Somerset and Dorset, saving the NHS well over £20,000 while easing patients’ suffering and helping to save lives.`,
                ],
            },
