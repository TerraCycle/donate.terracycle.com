...
const charityName = "Aspergers Youth Club";
...
module.exports = () => {
    return {
        data: {
            ...
            introduction: {
                charityLogoFileName: "141086 Aspergers Youth Club-Mobile.png",
                paragraphs: [
            ...
            about: {
                ...
                paragraphs: [
                    `We are a small non profit organisation. We support young people that have Asperger's - (originally) but as they no longer diagnose that we say anyone that is on the Autistic spectrum from the age of 8 years upwards. We do not turn anyone away and they can decide themselves when they no longer wish to come along.`,
                    `We also support carers and parents. We provide a safe, non judgmental environment, where they can socialise and make friends. We also go out to bowling, out for meals and have a day away to the seaside once a year. We meet once a week and let the members decide what they want to do. We have a PS4 and a Xbox, lots of craft stuff, Lego and board games. A lot of them love bingo - so we play bingo every week. This also helps them with their number skills. And that you can't always win.`,
                ],
            },
