...
const charityName = "The Globe Foundation";
    ...
    return {
        data: {
            ...
            about: {
                ...
                paragraphs: [
                    `Hello. We're Globe, a non profit organisation working to reduce the impact of modern living on the climate. Founded in Staffordshire, we aim to better the health & wellbeing of people & planet, through environmental education &amp; awareness, to reduce our impact on the climate.`,
                ],
            },
