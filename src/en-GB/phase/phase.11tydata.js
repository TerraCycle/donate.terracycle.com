...
module.exports = () => {
    return {
        data: {
            ...
            introduction: {
                charityLogoFileName: "142030 PHASE-Mobile.png",
                paragraphs: [
            ...
            about: {
                ...
                paragraphs: [
                    `${charityName} is a small charity with a big mission – to work alongside young people to promote their wellbeing and resilience. In 2021 this mission is more important than ever as we all face the challenges of lockdown, social distancing and stress caused by Covid 19.`,
                    `We strongly believe that when children are supported early it is possible to prevent more serious emotional and mental health issues developing.`,
                    `We reach young people through schools but increasingly through other channels like social media and online resources. Our resources cover resilience, emotional and physical wellbeing, dealing with stress and uncertainty, and planning for the future.`,
                ],
            },
