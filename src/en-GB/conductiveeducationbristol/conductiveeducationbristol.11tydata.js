...
const charityName = "Conductive Education Bristol";
...
module.exports = () => {
    return {
        data: {
            ...
            introduction: {
                charityLogoFileName: "141772 Conductive Education Bristol-Mobile.jpg",
                paragraphs: [
            ...
            about: {
                ...
                paragraphs: [
                    `CEBristol is a Not for Profit organisation running Conductive Education sessions and services supporting children and adults with neurological movement disorders across Bristol, Somerset, Wiltshire, BANES, North Somerset and South Wales. Conductive Education sessions run by qualified staff offer a fun motivating group setting in which children and adults are given the opportunity to develop their physical skills, communication, self-care skills, problem solving skills and confidence. Putting developing skills into practice during a range of daily activities from rolling, crawling, walking, playing with friends to snack time. Ultimately building on each individual's self-esteem and problem solving skills and teaching them the tools they will need to actively conduct their daily lives with Confidence’.`,
                ],
            },
