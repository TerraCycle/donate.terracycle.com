...
const charityName = "Hamstreet School Association";
...
module.exports = () => {
    return {
        data: {
            ...
            introduction: {
                charityLogoFileName: "hamstreet_school_association.jpg",
                charityLogoHeight: {
                    mobile: 65,
                    desktop: 110,
                },
            ...
            about: {
                ...
                paragraphs: [
                    `The ${charityName} is a charity that supports our primary school by raising much needed funds to support the children's education by purchasing additional resources to support learning in all aspects of the curriculum from physical to academic. We are a small committee of volunteers who willingly give our time to arrange events and source grants and other ways of possible funding. Throughout the year we raise funds through various events but we are very passionate about ensuring that we do everything we can to be eco-friendly, reduce waste and recycle where possible.`,
                ],
            },
