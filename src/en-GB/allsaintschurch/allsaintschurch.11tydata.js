...
const charityName = "All Saints Church";
    ...
    return {
        data: {
            ...
            about: {
                ...
                paragraphs: [
                    `Our Parish Churches are places where we can worship God, where we can grow in love and service, and invite all who enter to pause and make space for God who made us and who meets us in Jesus Christ. On behalf of the whole community, may I welcome you to All Saints Parish Birchington. We are blessed with three churches, the mother church of All Saints, Birchington, with its Daughter churches of St Mildred in Acol and St Thomas’ in Minnis Bay.`,
                    `We have an active junior church at All Saints and “Messy Church” at St Thomas, in addition to inspiring worship at our services, thoughtful preaching and teaching on the bible, excellent organists and a fantastic robed choir.`,
                    `Many groups, catering for all skills and tastes and a wide variety of social events occur regularly throughout the church year.`,
                ],
            },
