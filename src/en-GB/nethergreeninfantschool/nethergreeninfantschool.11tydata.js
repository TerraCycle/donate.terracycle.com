...
const charityName = "Nether Green Infant School";
...
module.exports = () => {
    return {
        data: {
            ...
            introduction: {
                charityLogoFileName: "141350 Nether Green Infant School-Mobile.jpg",
                paragraphs: [
            ...
            about: {
                ...
                paragraphs: [
                    `${charityName} fundraising has been essential for the school to buy new resources, books and apparatus, all of which help to enrich our children’s learning experience. The money raised last year from various recycling schemes &amp; PTA events have helped pay for ongoing work in our Woodland Area, including the purchase of a shelter and outside lights, a pantomime, road safety signs and the new playground markings.`,
                ],
            },
