...
const charityName = "The Trash Cafe Network";
    ...
    return {
        data: {
            ...
            about: {
                ...
                paragraphs: [
                    `We are about saving good food from going to waste. You can come along and shop or eat and you decide the value of the food by paying in time, cash, skills or item donations.`,
                    `We started in September 2015 by becoming partners of The Real Junk Food Project and started at our first venue in October 2015 feeding only around 15 people a week.`,
                    `${charityName} now supports over 4,000 people a week in the South of Hampshire with food and other resources saved. We not only offer our shops, hampers and cafes but also work with a wide range of other fantastic organisations.`,
                ],
            },
