...
const charityName = "Upcycle Kernow";
    ...
    return {
        data: {
            ...
            about: {
                ...
                paragraphs: [
                    `Upcycle Kernow is a Community Interest Company, nurturing people and communities by offering safe, creative environments to explore the benefits of upcycling in Cornwall. We are a sustainable, non-profit making community hub for recycling and education. We campaign to create empowerment and raise awareness of sustainable living and the effects of a local circular economy, by way of various volunteer-led projects, schemes and workshops.`,
                ],
            },
