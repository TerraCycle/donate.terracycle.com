...
const charityName = "ADAPT Prembabies";
...
module.exports = () => {
    return {
        data: {
            ...
            introduction: {
                charityLogoFileName: "140418 ADAPT Prembabies Ltd-Mobile.jpg",
                paragraphs: [
            ...
            about: {
                ...
                paragraphs: [
                    `ADAPT is a small, local charity who provide support to families with premature and poorly babies who need intensive neonatal care at birth on the neonatal units in Leicester and after they have gone home.`,
                    `ADAPT was set up in 1995 by parents Rob and Fiona Morris after having their son Harry 11 weeks early. Harry spent nine months on the neonatal unit at the Leicester Royal. Whilst there, they spoke to other parents going through similar experiences and found that talking to others who appreciated their situation helped enormously.`,
                    `This is how ADAPT was born.`,
                    `Once discharged from the neonatal unit, ADAPTs support continues in the form of parent support groups called In B Tweenies.`,
                ],
            },
