...
module.exports = () => {
    return {
        data: {
            ...
            introduction: {
                charityLogoFileName: "140302 Kicks Count 2 out of 2-Mobile.png",
                paragraphs: [
            ...
            about: {
                ...
                paragraphs: [
                    `${charityName} is the UK's leading baby movement campaign. 2020 saw the lowest stillbirth rate since records began in 1927, showing the impact of our work, but we can’t stop here. Around 7 babies are still stillborn in the UK every day and there are still so many more lives to save.`,
                    `A baby's movements are a sign of their wellbeing; by educating and empowering parents-to-be with information and confidence, babies found to be in distress can be delivered safely. As a small charity with a big voice and even bigger aims, know that we’re grateful for your support. Let’s save babies’ lives, together.`,
                ],
            },
