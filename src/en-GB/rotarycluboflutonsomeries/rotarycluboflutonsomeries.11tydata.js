...
const charityName = "Rotary Club of Luton Someries";
...
module.exports = () => {
    return {
        data: {
            ...
            introduction: {
                charityLogoFileName: "139080 Luton Someries Rotary Charity Fund-Mobile.jpg",
                paragraphs: [
            ...
            about: {
                ...
                paragraphs: [
                    `The ${charityName} collects items for upcycling in order to raise funds for local charities and local youth projects. For example, we donated a new marquee to a local scout group and during the pandemic lockdowns we provided food deliveries to needy households. Please help us to continue to support our local community.`,
                ],
            },
