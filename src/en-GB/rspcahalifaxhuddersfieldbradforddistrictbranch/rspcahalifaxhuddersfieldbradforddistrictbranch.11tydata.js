...
const charityName = "RSPCA Halifax, Huddersfield, Bradford & District Branch";
...
module.exports = () => {
    return {
        data: {
            ...
            introduction: {
                charityLogoFileName: "139558 RSPCA Halifax, Huddersfield and District Branch-Mobile.jpg",
                paragraphs: [
            ...
            about: {
                ...
                paragraphs: [
                    `The ${charityName} is a self funded, local animal charity. Our main aim is to rehabilitate, care and find loving homes for all the animals that come into our centre.`,
                    `We work with all our animals to prepare them for re-homing - undergoing health checks and behavioural assessments before following a training and rehabilitation plan to get ready for their new homes. We rely heavily on our community’s support, so please support us today!`,
                ],
            },
