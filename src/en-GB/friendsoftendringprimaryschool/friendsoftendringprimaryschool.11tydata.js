...
const charityName = "Friends Of Tendring Primary School";
    ...
    return {
        data: {
            ...
            about: {
                ...
                paragraphs: [
                    `Tendring Primary School is a small school in the Village of Tendring. The charity, ${charityName}, fundraise in order to help fund or purchase items or activities to help enhance the children’s education and school experience. The school is a ${site.brandName} public drop-off point for most of their schemes and the school prides itself on having a strong community centric recycling scheme with the ethos that everyone can make a difference.`,
                ],
            },
