...
const charityName = "Ellie's Fund";
...
module.exports = () => {
    return {
        data: {
            ...
            introduction: {
                charityLogoFileName: "Ellie's Fund YBTC-Mobile.jpg",
                paragraphs: [
            ...
            about: {
                ...
                paragraphs: [
                    `In 2007, Ellie, then aged 11, was diagnosed with an aggressive brain tumour. She battled the odds, became an expert fundraiser and left behind a legacy; Ellie's Fund. The fund raised over £25,000 during Ellie's lifetime and has since raised over £250,000, helping to provide financial assistance to families who have a child going through brain tumour treatment in Yorkshire and support pioneering research projects. Ellie's Fund merged with Yorkshire's Brain Tumour Charity to become an official YBTC fund in 2017. The fund focuses on turning everyday rubbish including pens, ink cartridges, gloves, water filters and stamps into money for life-changing research.`,
                ],
            },
